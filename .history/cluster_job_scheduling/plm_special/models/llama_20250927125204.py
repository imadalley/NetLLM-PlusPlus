    ...
    def forward(
        ...
        **kwargs,
        ...
        for idx, decoder_layer in enumerate(self.layers):
            ...
            # ========================= FIX #1: RENAME VARIABLE =========================
            # The variable was `past_key_value` (no s), which is incorrect.
            past_key_values_for_layer = past_key_values[idx] if past_key_values is not None else None
            # =========================================================================
                ...
                def create_custom_forward(module):
                    def custom_forward(hidden_states, attention_mask, position_ids):
                        return module(
                            ...
                            # ========================= FIX #2: RENAME KEYWORD ARGUMENT =========================
                            past_key_values=past_key_values_for_layer,
                            # =================================================================================
