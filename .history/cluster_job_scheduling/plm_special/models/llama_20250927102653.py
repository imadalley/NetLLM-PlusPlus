            ...
            if self.gradient_checkpointing and self.training:
                def create_custom_forward(module):
                    def custom_forward(*inputs):
                        # The inputs tuple now correctly includes position_ids
                        return module(*inputs, output_attentions=output_attentions, past_key_value=past_key_value)
                    return custom_forward

                # We now pass position_ids as a main argument to the checkpoint function
