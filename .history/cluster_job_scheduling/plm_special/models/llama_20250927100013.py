...
class LlamaModel(LlamaPreTrainedModel):
    """
    Customized LLaMA model for NetLLM.
    Key differences from HuggingFace:
    1. Early stopping with `stop_layer_idx`.
    ...
    def __init__(self, config: LlamaConfig):
        ...
        # HuggingFace expects config, not hidden_size/num_heads manually
    ...
    def _prepare_decoder_attention_mask(self, attention_mask, input_shape, inputs_embeds, past_key_values_length):
        """Create the causal + expanded attention mask."""
