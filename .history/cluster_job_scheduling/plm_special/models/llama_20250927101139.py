    ...
    def forward(
        ...
        **kwargs,
        ...
        try:
            ...
            raise IndexError(
                'stop_layer_idx for early stopping should not exceed the number of layers in plm.')
        ...
        for idx, decoder_layer in enumerate(self.layers):
            ...
            # THE CRITICAL CHANGE IS HERE: We pass position_ids to the checkpoint function
            if self.gradient_checkpointing and self.training:
                def create_custom_forward(module):
                    def custom_forward(*inputs):
                        # module expects: hidden_states, attention_mask, position_ids, past_key_value, output_attentions, use_cache
                        return module(inputs[0], attention_mask=inputs[1], position_ids=inputs[2], past_key_value=past_key_value, output_attentions=output_attentions, use_cache=use_cache)
