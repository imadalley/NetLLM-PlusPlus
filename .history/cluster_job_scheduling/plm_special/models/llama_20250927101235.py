...
@add_start_docstrings("The customized LLaMA model with early stopping support.")
class LlamaModel(LlamaPreTrainedModel):
    def __init__(self, config: LlamaConfig):
        ...
        self.rotary_emb = LlamaRotaryEmbedding(
            config.hidden_size // config.num_attention_heads,  # dim per head
    ...
    def forward(
        ...
        **kwargs,
        ...
        try:
            ...
            raise IndexError("stop_layer_idx exceeds number of layers")
            ...
            if self.gradient_checkpointing and self.training:
                ...
                def create_custom_forward(module):
                    def custom_forward(*inputs):
                        return module(*inputs, past_key_value, output_attentions, position_embeddings=(cos, sin))
                ...
                layer_outputs = decoder_layer(
                    ...
                    use_cache=use_cache,
                    position_embeddings=(cos, sin),  # ✅ FIXED
                )
