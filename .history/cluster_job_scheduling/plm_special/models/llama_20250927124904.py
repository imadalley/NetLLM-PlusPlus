        ...
        **kwargs,
        ...
        for idx, decoder_layer in enumerate(self.layers):
            ...
            if self.gradient_checkpointing and self.training:
                ...
                # ========================= THIS IS THE FIX =========================
                # We define a function that explicitly uses keyword arguments to call the decoder layer.
                # This is much more robust than relying on positional arguments (*inputs).
